...
python -u main.py -m=dab_detr --output_dir=logs/DABDETR_ARTIFICIAL_PLATE/R50/plates_1500 --batch_size=1 --epochs=100 --lr_drop=40 --number_of_classes_new=103 --resume=/fs/pool/pool-lambacher/Cluster_Projects/DAB-DETR/download_checkpoint/checkpoint.pth --coco_path=/fs/pool/pool-lambacher/Cluster_Projects/data/plates_1500
